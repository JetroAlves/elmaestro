...
const Footer: React.FC<FooterProps> = ({ onNavigateAdmin }) => {
  return (
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li><a href="#" className="hover:text-[#90784E] transition-colors">Produtos</a></li>
            <li><a href="#" className="hover:text-[#90784E] transition-colors">Receitas</a></li>
            <li><a href="#" className="hover:text-[#90784E] transition-colors">Visitantes</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            ...
            <li><a href="#" className="hover:text-[#90784E] transition-colors">Onde Encontrar</a></li>
