...
const PRODUCTS = [
  { id: 1, img: "https://mgqueijos.com.br/wp-content/uploads/2024/11/Gorgonzola-El-Maestro-Pe%C3%A7a-286x300.png", isLogo: true }, 
  { id: 2, img: "https://mgqueijos.com.br/wp-content/uploads/2025/08/Mussarela-Argentino-El-Maestro-Ralado-140g-768x870.png" }, 
  { id: 3, img: "https://mgqueijos.com.br/wp-content/uploads/2024/11/Queijo_Azul_Cunha-300x296.png" }, 
  { id: 4, img: "https://mgqueijos.com.br/wp-content/uploads/2024/04/COD-157-MUSS-FAT-140-258x300.png" }, 
  { id: 5, img: "https://mgqueijos.com.br/wp-content/uploads/2024/11/Gorgonzola-El-Maestro-Pe%C3%A7a-286x300.png" }, 
  { id: 6, img: "https://mgqueijos.com.br/wp-content/uploads/2024/04/Mussarela-Argentino-El-Maestro-Ralado-25kg-300x300.png" }, 
];

const StoreLocatorSection: React.FC = () => {
  return (
    <section className="bg-[#FCFAE6] py-24 px-4 md:px-8 overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-24">
          ...
          <div className="flex items-center animate-scroll hover:pause-scroll">
            {[...PRODUCTS, ...PRODUCTS].map((product, index) => (
              <div 
                ...
                className="flex-shrink-0 px-10 w-56 md:w-80 lg:w-96 flex items-center justify-center"
              >
                <div className="transform transition-transform hover:scale-110 duration-500 w-full">
                  <img 
                    src={product.img} 
                    alt="Mg Queijos Product" 
                    className="w-full h-auto drop-shadow-[0_25px_30px_rgba(0,0,0,0.18)] object-contain"
                  />
                </div>
              </div>
            ))}
        ...
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left space-y-8 lg:w-[35%] z-20">
          ...
          <button className="bg-[#101010] hover:bg-[#90784E] text-white px-12 py-5 rounded-full font-black text-sm uppercase tracking-widest flex items-center gap-3 transition-all shadow-2xl hover:scale-105 active:scale-95 group">
